...
Implementation and scripts for DCA. This repo **does not** include a full RL framework and **does not depend on or import verl/slime**; it provides DCA advantage computation. **main** contains the DCA core and **both VERL and Slime adapters**: use [docs/INTEGRATION_VERL.md](docs/INTEGRATION_VERL.md) for [verl](https://github.com/verl-project/verl), [docs/INTEGRATION_SLIME.md](docs/INTEGRATION_SLIME.md) for [THUDM/slime](https://github.com/THUDM/slime).
...
├── dca/                 # Advantage, metrics, data utils; verl_integration + slime_integration (main: both adapters)
├── scripts/
...
│   ├── run_slime_baselines.sh # Slime three-baseline comparison
...
├── configs/slime/             # Slime config snippets
└── tests/
```
